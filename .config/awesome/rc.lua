...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "}", function () awful.util.spawn("subl") end),
    awful.key({ modkey,           }, "+", function () awful.util.spawn("google-chrome") end),
    awful.key({ modkey,           }, "-", function () awful.util.spawn("idea.sh") end),
    awful.key({ modkey,           }, "{", function () awful.util.spawn("gvim") end),
...
clientkeys = awful.util.table.join(
    ...
    -- Volume
    awful.key({}, "#122", function () awful.util.spawn("volti-remote -d") end),
    awful.key({}, "#123", function () awful.util.spawn("volti-remote -i") end),
    awful.key({}, "#121", function () awful.util.spawn("volti-remote -m") end),
    -- Brightness
...
run_once("volti")
run_once("ck-launch-session awesome")
